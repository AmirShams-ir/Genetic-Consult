Public Class users1
    ...
    Private Sub users_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DataGridView1.Columns.Item(1).HeaderText = "نام کاربری"
        DataGridView1.Columns.Item(2).HeaderText = "رمز عبور"
        Me.DataGridView1.Columns.Item(3).Visible = False
        Me.DataGridView1.Columns.Item(6).Visible = False
        Me.DataGridView1.Columns.Item(7).Visible = False
        Me.DataGridView1.Columns.Item(8).Visible = False
        Me.DataGridView1.Columns.Item(9).Visible = False
        DataGridView1.Refresh()
        Conn1.Close()
    End Sub
End Class